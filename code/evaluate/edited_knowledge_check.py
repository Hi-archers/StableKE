...
if __name__ == "__main__":
    ...
    parser.add_argument("-file_path", default="", required=False, help="")

    args = parser.parse_args()

    output_o_results, output_e_results, apo_results = check_answer(args)

    print(output_o_results)
    print(output_e_results)
